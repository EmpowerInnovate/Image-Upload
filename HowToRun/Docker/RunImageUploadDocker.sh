...
***************
'
    echo "An error occurred in RunImageUploadDocker.sh . Exiting..." >&2
    exit 1
}
...
echo "Starting ImageUpload-logic"
...
#sh InstallImageUploadLogicDocker.sh
echo "Started ImageUpload-logic. Do tail -f logs/ImageUpload-logic.log from "+$CURRENT_DIR
