...
abort()
{
    echo >&2 '
***************
*** ABORTED StopImageUploadDocker.sh Docker ***
***************
'
    echo "An error occurred in StopImageUploadDocker.sh docker . Exiting..." >&2
    exit 1
}
...
# INFO: Prune will remove unwanted docker images from local cache.
